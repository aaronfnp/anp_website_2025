          ...
          >
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button
                ...
                className="inline-flex w-full justify-center rounded-md bg-white-600 px-3 py-2 text-sm font-semibold text-blue shadow-sm hover:bg-blue-500 hover:text-white sm:ml-3 sm:w-auto"
              >
                Confirm
              </button>
              <button
